...
\title{Programación Estadística: Tipos de Datos  }
...
\hypersetup{breaklinks=true,
            ...
            pdfauthor={Adrián Sosa () and  (Universidad Veracruzana)},
             pdfkeywords = {},  
            pdftitle={Programación Estadística: Tipos de Datos},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
Carácter: cualquier tipo de información que sea texto, incluso los
números pueden ser guardados como texto, este tipo de dato debe ser
guardado entre comillas "``. Ejemplo(''Esto es una cadena").

Complejo: cualquier número complejo que tenga parte real e imaginaria.

Lógico: es una variable lógica, sólo puede admitir valores de True
...
Para declarar una variable de tipo Carácter se ocupan los siguientes
comandos:
